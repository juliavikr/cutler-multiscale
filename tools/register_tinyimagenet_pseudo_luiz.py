...
register_coco_instances(
    "tinyimagenet_5c_final_pseudo",
    {},
    os.path.join(_ANNO_DIR_5C, "v1_final_pseudo.json"),
    _IMAGE_ROOT_5C,
)

register_coco_instances(
    "tinyimagenet_5c_combined_pseudo",
    {},
    os.path.join(_ANNO_DIR_5C, "v1_combined_pseudo.json"),
    _IMAGE_ROOT_5C,
)
